...
class Book_Item {
  ...
  factory Book_Item.fromJson(Map<String, dynamic> json) {
    return Book_Item(
        ...
        voice_actor: json['voice_actor'].toString(),
        dar_alnasher: json['dar_alnasher'].toString(),
        ...
        name_list_main: json['name_list_main'].toString(),
        name_list_sub: json['name_list_sub'].toString(),
